...
<div class="banquan">
	<div class="banquan_zhong">
		...
		</ul><ul class="ul_banquan_3">
			<li class="li_banquan">联系我们</li>
			<li class="li_banquan01">地址：广西省百色市右江区百色学院东合校区</li>
			<li class="li_banquan02">电话：17807705665</li>
		</ul><ul class="ul_banquan_4">
			<li class="li_banquan">版权所有&copy;百色学院</li>
		</ul>
	</div>
</div>