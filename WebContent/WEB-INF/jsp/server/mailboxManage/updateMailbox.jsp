		...
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="title" value="${mailbox.title}"  autocomplete="off" class="layui-input" lay-verify="realName" placeholder="请输入标题" style="width:390px">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">内容：</label>
				<div class="layui-input-block">
					 <textarea placeholder="请输入内容" class="layui-textarea" name="content">${mailbox.content}</textarea>
				</div>
			</div>
...
layui.use([ 'form', 'layer'],
		...
		form.on('submit(demo1)', function(data) {
			$.ajax({
				type : "post",
				url : "${ctx}/server/mailbox/updateMailbox.action",
				dataType:"json",
				data : {
					"id" : '${mailbox.id}',
