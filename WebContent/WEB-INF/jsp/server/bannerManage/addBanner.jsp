	...
	<div style="margin: 15px;">
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="orderStatus" autocomplete="off" class="layui-input" lay-verify="orderStatus" placeholder="请输入排序" style="width:390px">
				</div>
			</div>
			<div class="layui-form-item">
...
layui.use([ 'form', 'layer'],
		...
		form.on('submit(demo1)', function(data) {
			$.ajax({
				type : "post",
				url : "${ctx}/server/banner/addBanner.action",
				dataType:"json",
				data : {
