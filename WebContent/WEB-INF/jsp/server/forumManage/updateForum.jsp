		...
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="title" value="${forum.title}"  autocomplete="off" class="layui-input" lay-verify="realName" placeholder="请输入标题" style="width:390px">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">内容：</label>
				<div class="layui-input-block">
					 <textarea placeholder="请输入内容" class="layui-textarea" name="content">${forum.content}</textarea>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="userId" value="${forum.userId}" autocomplete="off" class="layui-input" lay-verify="userId" placeholder="请输入用户编号" style="width:390px">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width:390px">
					<select name="isEffect" lay-verify="collType">
						<option value="1" <c:if test="${forum.isEffect == 1}">selected="selected"</c:if>>是</option>
						<option value="0" <c:if test="${forum.isEffect == 0}">selected="selected"</c:if>>否</option>
					</select>
				</div>
			</div>
...
layui.use([ 'form', 'layer'],
		...
		form.on('submit(demo1)', function(data) {
			$.ajax({
				type : "post",
				url : "${ctx}/server/forum/updateForum.action",
				dataType:"json",
				data : {
