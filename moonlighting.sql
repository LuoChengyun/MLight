/*
 ...
 Source Schema         : moonlighting

 Target Server Type    : MySQL
 Target Server Version : 50621
 File Encoding         : 65001

 Date: 21/09/2020 23:00:46
*/
...
CREATE TABLE `adver`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '题标',
  `content` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '容内',
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '片图',
...
CREATE TABLE `banner`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '联关用户表',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '题标',
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '片图',
  `order_status` int(11) DEFAULT NULL,
  `is_effect` int(11) DEFAULT 1 COMMENT '否是有效，1有效，0无效',
  `create_time` datetime(0) DEFAULT NULL COMMENT '立建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `chat`  (
  ...
  `chat_signal` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '聊天信号',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of chat
-- ----------------------------
INSERT INTO `chat` VALUES (1, 10003, 10000, '请问在吗？？', NULL, '2019-03-24 16:22:21', 1, 0, 0, '20190324162221cd1cd');
INSERT INTO `chat` VALUES (2, 10000, 10003, '在的请问有事吗？？', NULL, '2019-03-24 16:23:32', 1, 0, 0, '20190324162221cd1cd');
INSERT INTO `chat` VALUES (3, 10003, 10000, '明天一起吃个饭呗', NULL, '2019-03-24 16:30:52', 1, 0, 0, '20190324162221cd1cd');
INSERT INTO `chat` VALUES (4, 10000, 10002, '您好', NULL, '2019-03-24 16:32:04', 1, 0, 0, '2019032416320458132');
INSERT INTO `chat` VALUES (5, 10000, 10003, 'okok', NULL, '2019-03-24 16:35:42', 1, 0, 0, '20190324162221cd1cd');
INSERT INTO `chat` VALUES (6, 10000, 10003, '地点哪里？？', NULL, '2019-03-24 16:39:50', 1, 0, 0, '20190324162221cd1cd');
INSERT INTO `chat` VALUES (7, 10003, 10000, '学校食堂吧', NULL, '2019-03-24 16:40:45', 1, 0, 0, '20190324162221cd1cd');
...
INSERT INTO `chat` VALUES (11, 10002, 10000, '你好', NULL, '2019-04-27 13:43:47', 1, 0, 0, '2019032416320458132');
INSERT INTO `chat` VALUES (12, 10002, 10000, '在吗？', NULL, '2019-04-29 20:50:35', 1, 0, 0, '2019032416320458132');
INSERT INTO `chat` VALUES (13, 10003, 10000, '好像三楼有个麻辣香锅还不错！', NULL, '2019-05-05 21:27:17', 1, 0, 0, '20190324162221cd1cd');
INSERT INTO `chat` VALUES (14, 10000, 10002, '你好，在的', NULL, '2019-05-11 16:05:41', 0, 0, 0, '2019032416320458132');
INSERT INTO `chat` VALUES (15, 10000, 10003, '好，那明天就去那里', NULL, '2019-05-11 16:06:26', 1, 0, 0, '20190324162221cd1cd');
...
INSERT INTO `forum` VALUES (3, 10002, '给大家推荐本书', '下面这本java ee企业级应用开发教程，出于黑马程序员，此书的内容编写的十分紧凑、简洁而不简单，里边的案例讲解的知识点很清晰，很人性化非常适合学习，推荐给正在学java ee的小伙伴。', 'http://localhost:8080/moonlighting/forumImages/202001051131507775b.jpg', 1, '2019-03-24 16:13:37');
...
CREATE TABLE `forum_reply`  (
  ...
  `user_id` int(11) NOT NULL COMMENT '联关用户表',
  `reply_content` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '复回内容',
  `reply_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '复回图片',
  `reply_time` datetime(0) DEFAULT NULL COMMENT '复回时间',
...
CREATE TABLE `mailbox`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '题主',
  `content` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '容内',
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (1, 10000, '兼职平台1.0版本上线了！', '兼职平台1.0版本上线了，请大家尽情体验吧！在体验的过程中碰到什么问题，可以通过平台信箱告知平台哦，祝大家生活愉快！', '', '2019-03-24 16:47:36');
...
CREATE TABLE `system_upset`  (
  ...
  `welcom_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '欢迎语',
  `company_addres` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'å€åœ°',
  `company` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '司公',
  ...
  `company_logo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'logo',
  `we_chat` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '信微',
...
-- ----------------------------
INSERT INTO `system_upset` VALUES (3, 10000, '欢迎来到大学生校园兼职平台', '广西百色学院', '大学生校园兼职平台', '1529117748', '17807705665', 'http://localhost:8080/moonlighting/systemImages/2020010511393275ac8.png', 'luxing13953', '2019-03-22 17:26:51');
...
CREATE TABLE `user`  (
  ...
  `nick_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '称昵',
  `password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '码密',
  `user_leven` int(11) DEFAULT 0 COMMENT '户用等级',
  `user_category` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '普通用户类别',
  `sex` int(11) DEFAULT 0 COMMENT '别性0女1男',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '话电',
  `pirthday` datetime(0) DEFAULT NULL COMMENT '日生',
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '箱邮',
  `header_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '像头',
  `question` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '回找密码问题',
  `answer` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '回找密码答案',
  `create_time` datetime(0) DEFAULT NULL COMMENT '立建时间',
  `is_effect` int(11) DEFAULT 1 COMMENT '否是有效，1有效，0无效',
  `is_work` int(11) DEFAULT 1 COMMENT '0不可以发布1可以发布',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '注备',
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10005 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (10000, '小辉', '小辉', 'e10adc3949ba59abbe56e057f20f883e', 1, '管理员', 1, '17807705665', NULL, '1395302251@qq.com', 'http://localhost:8080/moonlighting/headerImages/2020010511220709699.jpg', NULL, NULL, '2019-03-22 17:16:07', 1, 1, '单位：右江公司，地址：百色右江区，电话：17807705665，qq：1395302251');
INSERT INTO `user` VALUES (10001, '小黄', '小黄', 'e10adc3949ba59abbe56e057f20f883e', 1, '管理员', 1, '17807705665', NULL, '1395302251@qq.com', 'http://localhost:8080/moonlighting/headerImages/202001051121571b236.jpg', NULL, NULL, '2019-03-24 10:32:59', 1, 1, NULL);
INSERT INTO `user` VALUES (10002, '黄先生', '小辉同学', 'e10adc3949ba59abbe56e057f20f883e', 0, '学生', 1, '17807705665', NULL, '1395302251@qq.com', 'http://localhost:8080/moonlighting/headerImages/20200105112141830e0.jpg', NULL, NULL, '2019-03-24 10:46:23', 0, 1, '可以发布兼职');
INSERT INTO `user` VALUES (10003, '陈先生', '小陈88', 'e10adc3949ba59abbe56e057f20f883e', 0, '学生', 1, '17807705665', NULL, '1529117748@qq.com', 'http://localhost:8080/moonlighting/headerImages/20200105112128eaba6.jpg', '我的妈妈叫啥名字？', '小秀秀', '2019-03-24 10:48:24', 1, 1, '单位：右江公司，地址：右江区，电话：17807705665，qq：1395302251');
INSERT INTO `user` VALUES (10004, '小黄', '小黄88', 'e10adc3949ba59abbe56e057f20f883e', 0, '学生', 1, '17807705665', NULL, '123456@qq.com', 'http://localhost:8080/moonlighting/headerImages/2020010511204514401.jpg', '我是谁呢？', '大地', '2019-04-08 11:06:34', 1, 1, NULL);
...
CREATE TABLE `work`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `work_category` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '职兼类别,促销、传单派发、设计、家教、会计、计算机、服务员、其他',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '话电',
  `content` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '容内',
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '片图',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '题标',
